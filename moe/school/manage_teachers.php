...
global $DB;
 ...
 $PAGE->set_url(new moodle_url('/local/newwaves/moe/manage_teachers.php'));
 ...
 <?php
  $sql = "SELECT id, uuid, title, surname, firstname, middlename , gender, email, phone, role, status FROM
  ...
  echo "<tr class='font-weight-bold' >";
       echo "<th class='py-3'>SN</th><th>Staff No.</th><th>Name</th><th>Email</th><th>Phone</th><th>Status</th><th class='text-center'>Action</th></tr>";
  echo "</thead>";
  echo "<tbody>";
        foreach($headadmin as $row){
            ...
            $viewHref = "window.location='teacher/view_teacher.php?q=".mask($_GET_URL_school_id)."&u=".mask($row->id)."'";
