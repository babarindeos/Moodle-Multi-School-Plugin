...
// retrieve user data
 $student = new Student();
 $getStudent = $student->getStudentProfileById($DB, $_GET_URL_student_id);
 ...
 echo $OUTPUT->header();
 echo "<div class='mb-5'><h2><small> [Student Profile ]</small></h2></div>";
    ...
    <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                  ...
                  <table class="table table-stripped table-hover">
                      <tr><td class='font-weight-bold' style='width:20%;' >Admission No.</td><td><?php echo $admission_no; ?></td></tr>
                      ...
                      <tr><td class="font-weight-bold">Class</td><td><?php echo acadclass($class); ?></td></tr>
