                  ...
                  <div class='text-right'>
                              <?php
                                  if ($suspendedStatus==0){
                                        $pg = 'view_schooladmin.php';
                                        $suspendhref = $CFG->wwwroot.'/local/newwaves/utility/suspend.php?q='.mask($_GET_URL_school_id).'&h='.mask($_GET_URL_schooladmin_id).'&pg='.mask($pg).'&mu='.mask($currentUserMoodleId);
                                        if (!isset($_GET['q']) || $_GET['q']==''){
                              ...
                              ?>
                               ...
                               <?php
                                        ...
                                        $pg = 'view_schooladmin.php';
                                        $suspendhref = $CFG->wwwroot.'/local/newwaves/utility/unsuspend.php?q='.mask($_GET_URL_school_id).'&h='.mask($_GET_URL_schooladmin_id).'&pg='.mask($pg).'&mu='.mask($currentUserMoodleId);
                               ?>
