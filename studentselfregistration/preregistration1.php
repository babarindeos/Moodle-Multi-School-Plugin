...
if ($mform->is_cancelled()){
    redirect($CFG->wwwroot.'/local/newwaves/studentselfregistration/preregistration1.php', 'No School found. You cancelled the operation.');
...
//
        ...
        redirect($CFG->wwwroot."/local/newwaves/studentselfregistration/{$schoolinfo_href}");
//    }
...
<div class="row d-flex justify-content-right mt-4">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
        <h4 class='font-weight-normal'>Verify School Student</h4>
    </div>
</div>
