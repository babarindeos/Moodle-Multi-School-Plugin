...
<?php
      ...
      $school_dashboard = $CFG->wwwroot.'/local/newwaves/moe/school_dashboard.php';
...
<div>
  ...
  <button onclick="window.location='<?php echo $school_dashboard; ?>'" border='0' class='btn btn-success btn-sm'>School Dashboard</button>
