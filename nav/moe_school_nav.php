<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 border py-2 text-center" <?php if($active_menu_item=='headadmin'){echo "style='background-color:#f1f1f1; color:white; font-weight:bold';"; } ?>>
