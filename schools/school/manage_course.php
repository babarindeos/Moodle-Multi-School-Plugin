...
global $DB;
 ...
 $PAGE->set_url(new moodle_url('/local/newwaves/schools/create_course.php'));
 ...
 <?php
  $sql = "SELECT id, uuid, surname, firstname, middlename , gender, email, phone, role, status FROM
          {newwaves_course} and schoolid ={$_GET_URL_school_id} order by id desc";
...
//            }
            ...
            echo "<tr>";
                ...
                echo "<td>{$row->uuid}</td>";
                echo "<td class='text-left'>{$row->full_name} {$row->firstname}</td>";
